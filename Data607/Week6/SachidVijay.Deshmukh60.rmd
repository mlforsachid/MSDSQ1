...
* > [CSV file-1](https://github.com/mlforsachid/MSDSQ1/blob/master/Data607/Week5/AirlineSchedule.csv)
* > [CSV file-2](https://github.com/mlforsachid/MSDSQ1/blob/master/Data607/Week5/AirlineSchedule.csv)
* > [CSV file-3](https://github.com/mlforsachid/MSDSQ1/blob/master/Data607/Week5/AirlineSchedule.csv)
...
```{r Read Data}
Crime.Rate = read.csv("C:/MSDS/MSDSQ1/Data607/Week6/CrimeRate.csv", stringsAsFactors = F)
```
#### Preview Data
...
Stu.Grade = read.csv("C:/MSDS/MSDSQ1/Data607/Week6/StudentGrades.csv", stringsAsFactors = F)
```
#### Preview Data
...
```{r Read CityTmpData}
City.Temp = read.csv("C:/MSDS/MSDSQ1/Data607/Week6/CityTemp.csv", stringsAsFactors = F)
```
#### Preview Data
