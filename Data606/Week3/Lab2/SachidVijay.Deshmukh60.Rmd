...
* > [RPubs location of published file](http://rpubs.com/sachid/Data606Lab2)
...
Answer : Streak length of 1 will have one hit and one miss. Streak length of zero will have zero hit and one miss
...
Answer : Kobe's streak length follow poisson distribution. Based on bar plot, his typical streak length is zero which is mostly occuring with highest frequency of 40. His longest streak of baskets was of length 4
...
Answer : Streak lengths of the independent player follows a poisson distribution. The typical streak lenght is 0 with highest frequency of 33

- How long is the player's longest streak of baskets in 133 shots?

Answer - Longest streak basket is of length 5
...
Answer - Simulation produces output based on probability of event occurence. This would give us somewhat similar results if we repeat the simulation since the probability of the events remains same between two different simulations
...
Answer: Kobe Bryant's distribution of steak lenghts are very similar to that of streak lenghts of simulated shooter. The bar plots shows identical results for both Kobe and independent shooter. The typical streak length of 0 also remains the same for both Kobe and independent shoter. This proves Kobe's shootng pattern is independent and doesnot fit hot hand model. Similarity of Kobe's shooting pattern with independent shooter suggests us to reject hot hand model and it can be accepted that Kobe's shooting patterns are independent.
